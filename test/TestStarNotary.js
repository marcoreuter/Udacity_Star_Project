...
it('lets user2 buy a star and decreases its balance in ether', async() => {
    ...
    // "cheating" a bit here to account for gasprice. Maybe the boilerplate code is too old, but my code
    // does not allow me to set a gasprice of 0 without throwing an error!
    assert(Math.abs(value-starPrice)<1000000);
});
